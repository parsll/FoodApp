  ...
  return (
    <>
      <div className="m-auto mt-10 px-3 py-4">
        <h1 className="text-center text-3xl text-black">Our Works</h1>
        <section class="body-font overflow-hidden text-gray-600">
          <div class="container mx-auto p-5">
            <div class="mx-auto relative flex flex-wrap lg:w-4/5">
              <img
                alt="food"
                class="h-64 w-full rounded object-cover object-center lg:h-auto lg:w-1/2"
                src={backgroundImage}
              />
              <div class="mt-6 w-full bg-red-300 lg:mt-0 lg:w-1/2 lg:py-6 lg:pl-10 flex items-end">
