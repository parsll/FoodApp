    ...
    <>
      <div className="flex w-full justify-end">
        <div
          ...
          className="flex w-fit cursor-pointer items-center rounded-lg bg-white px-3 py-1 font-semibold text-primary"
        >
      ...
      {display === true && (
        <div className="fixed top-0 left-0 z-50 grid h-full w-full place-items-center overflow-y-scroll bg-black bg-opacity-75">
          <div className="grid w-[25rem] gap-3 rounded-md bg-white p-5 px-10">
            ...
            <h1 className="text-center text-3xl">Add Sells</h1>
            <div className="grid place-items-center gap-1 rounded-lg bg-[#F5F5F5] p-2">
